...
if __name__ == "__main__":
    ...
    calc_correlation_label(spark, ["title_contains_questionmark", "title_number_of_characters", "number_of_characters", "number_of_interpunction_characters", "interpunction_ratio", "number_of_lines", "average_line_length", "number_of_words", "average_word_length", "creation_seconds", "number_of_tags", "contains_language_tag", "contains_platform_tag", "user_age", "posts_amount", "answered_posts_amount"], "has_answer")