...
def create_scatter_data(spark):
    ...
    Example result:
    +---------+--------------------------+--------------------+----------------------------------+--------------------+---------------+-------------------+------------------+-------------------+--------------------+--------------+--------------------+------------------+---------------------+
    |bucket_id|title_number_of_characters|number_of_characters|number_of_interpunction_characters| interpunction_ratio|number_of_lines|average_line_length|   number_of_words|average_word_length|    creation_seconds|number_of_tags|            user_age|      posts_amount|answered_posts_amount|
    +---------+--------------------------+--------------------+----------------------------------+--------------------+---------------+-------------------+------------------+-------------------+--------------------+--------------+--------------------+------------------+---------------------+
